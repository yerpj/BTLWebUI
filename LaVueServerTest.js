...
var onLinux=true;
onLinux=(os.platform()==='win32')?false:true;
...
if(onLinux){
	...
	console.log("No Espruino management on Windows platform");
}
...
if(onLinux){
	...
	console.log("No LED management on Windows platform");
}
...
app.get("/",function(req,res){
    fs.readFile('index.html',function (err, data){// /home/JP/nodejs/webserver/index.html
		if(err)throw err;
